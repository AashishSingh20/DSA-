...
// Static Function 
    static int random(){
        // cout<<name<<endl;   // Nahi access kar payega
        // cout<<health<<endl;   // Nahi access kar payega
        // cout<<level<<endl;   // Nahi access kar payega
        // cout<<timetoComplete<<endl;  // Access ho jayega as it is a static variable
...
int Hero::timetoComplete = 5;  // Assigning value to Time To Complete variable using scope resolution operator
